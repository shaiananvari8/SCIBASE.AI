...
function makeFrame(frameIndex) {
  ...
  fillRect(frame, 38, 54, 240, 18, [232, 237, 244]);
  fillRect(frame, 38, 54, Math.round(240 * progress), 18, [185, 28, 28]);
  fillRect(frame, 38, 94, 240, 18, [232, 237, 244]);
  fillRect(frame, 38, 94, Math.round(120 * progress), 18, [183, 121, 31]);
  fillRect(frame, 38, 134, 240, 18, [232, 237, 244]);
  fillRect(frame, 38, 134, Math.round(120 * progress), 18, [21, 128, 61]);
  return frame;
}
